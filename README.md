...
![Papers](https://img.shields.io/badge/Papers-50-blue)
...
| 2020-05-28 | [Language Models are Few-Shot Learners](https://arxiv.org/abs/2005.14165) | OpenAI | - |
| 2020-07-31 | [PubMedBERT: Domain-Specific Language Model Pretraining for Biomedical Natural La](https://arxiv.org/abs/2007.15779) | Microsoft Research | [Code](https://huggingface.co/microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract) |
| 2019-01-25 | [BioBERT: a pre-trained biomedical language representation model for biomedical t](https://arxiv.org/abs/1901.08746) | Korea University | [biobert](https://github.com/dmis-lab/biobert) |
| 2019-03-26 | [SciBERT: A Pretrained Language Model for Scientific Text](https://arxiv.org/abs/1903.10676) | Allen Institute for AI | [scibert](https://github.com/allenai/scibert) |
...
### Top Organizations
- **Stanford University**: 7 papers
- **Microsoft Research**: 5 papers
- **Meta AI**: 4 papers
...
- **Allen Institute for AI**: 2 papers
- **University of Toronto**: 2 papers

### Most Active Categories
- 🔬 Foundation Models: 13 papers
- 🧬 Genomics & Precision Medicine: 6 papers
- 🩺 Medical Imaging & Vision: 5 papers
- 💊 Drug Discovery & Development: 5 papers
- 🏥 Clinical LLMs & Decision Support: 4 papers
